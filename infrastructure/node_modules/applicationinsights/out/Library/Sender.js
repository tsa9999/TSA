...
var Sender = /** @class */ (function () {
    function Sender(config, getAuthorizationHandler, onSuccess, onError, statsbeat) {
    ...
    */
    ...
    Sender.prototype._storeToDisk = function (envelopes) {
        return __awaiter(this, void 0, void 0, function () {
            var ex_1, ex_2, size, fileName, fileFullPath, ex_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 2:
                        ex_1 = _a.sent();
                        Logging.warn(Sender.TAG, "Failed to create folder to put telemetry: " + (ex_1 && ex_1.message));
                    ...
                    case 5:
                        ex_2 = _a.sent();
                        Logging.warn(Sender.TAG, "Failed to apply file access control to folder: " + (ex_2 && ex_2.message));
                    ...
                    case 7:
                        ...
                        FileSystemHelper.writeFileAsync(fileFullPath, Util.stringify(envelopes), { mode: 384 });
                        return [3 /*break*/, 9];
                    case 8:
                        ex_3 = _a.sent();
                        Logging.warn(Sender.TAG, "Failed to persist telemetry to disk: " + (ex_3 && ex_3.message));
